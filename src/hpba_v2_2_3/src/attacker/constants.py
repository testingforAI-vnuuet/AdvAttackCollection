...
ATTACK_BLACKBOX_TYPE = 'HPBA__black_box'
ATTACK_WHITEBOX_TYPE = 'HPBA__white_box'

LOSS_MSE = 'mse'
LOSS_SSIM = 'ssim'
LOSS_SSIM_MULTISCALE = 'ssim_multiscale'
