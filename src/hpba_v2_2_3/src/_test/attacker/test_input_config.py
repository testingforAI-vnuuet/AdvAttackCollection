...
Feature: 
"""
from src.hpba_v2_2_3.src.attacker.constants import LOSS_MSE, LOSS_SSIM, LOSS_SSIM_MULTISCALE
from src.hpba_v2_2_3.src.utility.constants import CONFIG_TXT, shared_incorrect_para_msg
import numpy as np
    ...
    tests = [
        {
            ...
            'result': attack_config.original_class in list(range(0,
                                                                 attack_config.num_class)) or attack_config.original_class == 0 or attack_config.original_class == 1 or attack_config.original_class == -1,
            'expected': True,
