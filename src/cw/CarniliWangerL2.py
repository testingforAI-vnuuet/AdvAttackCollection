"""
    The Carlini&WagnerL2 attack.
    Reference: https://github.com/cleverhans-lab/cleverhans/blob/master/cleverhans/tf2/attacks/carlini_wagner_l2.py
"""
...
class CarliniWagnerL2(object):
    def __init__(
        ...
        :param binary_search_steps (optional): The number of times we perform binary
                                search to find the optimal tradeoff-constant
                                between norm of the perturbation
    ...
    def _attack(self, x):
        ...
        # convenient function for comparing
...
def loss_fn(
    ...
    if targeted:
        ...
        # if un-targeted, optimize for making this class least likely.
...
"""
    Carnili&WangerL2 helper function
    Reference: https://github.com/cleverhans-lab/cleverhans/blob/master/cleverhans/tf2/utils.py
"""
